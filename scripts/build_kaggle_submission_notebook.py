"""Generate notebooks/aptos-resnet50-baseline.ipynb for exp300_d1_dropout_cosine submission.

Run from repo root:
    python scripts/build_kaggle_submission_notebook.py
"""
...
NB_PATH = Path("notebooks/aptos-resnet50-baseline.ipynb")
    ...
    "kaggle": {
        ...
        "dataSources": [
            ...
            },
            {
                ...
                "sourceId": 15476517,
                "datasetId": 9901356,
                "databundleVersionId": 16400032,
            },
            {
                "sourceType": "datasetVersion",
                "sourceId": 15475280,
                "datasetId": 9900594,
                "databundleVersionId": 16398702,
            },
            {
                "sourceType": "datasetVersion",
                "sourceId": 9900,
                "datasetId": 6209,
                "databundleVersionId": 9900,
            },
            {
                "sourceType": "datasetVersion",
                "sourceId": 15476696,
                "datasetId": 9901457,
                "databundleVersionId": 16400225,
            },
        ],
